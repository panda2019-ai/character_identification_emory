...
from experiments.sing_only.model.coref import *
...
pt_model_in = 'pretrained_models/sing_only.f1-4.pt.m'
pt_ftmp_in = 'pretrained_models/sing_only.f1-4.pt.ft.p'

data_out = 'data/sing_only.f1-4.states.p'
